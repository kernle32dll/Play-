...
namespace Iop
{
	...
	private:
		...
		enum
		{
			...
			REG_SMAP_RXFIFO_CTRL = 0x10001000,
			...
			REG_SMAP_EMAC3_MODE0 = 0x10002000,
			REG_SMAP_EMAC3_MODE1 = 0x10002004,
			REG_SMAP_EMAC3_TXMODE0_HI = 0x10002008,
			REG_SMAP_EMAC3_TXMODE0_LO = 0x1000200A,
			REG_SMAP_EMAC3_TxMODE1_HI = 0x1000200C,
			REG_SMAP_EMAC3_TxMODE1_LO = 0x1000200E,
			REG_SMAP_EMAC3_RxMODE = 0x10002010,
			REG_SMAP_EMAC3_INTR_STAT = 0x10002014,
			REG_SMAP_EMAC3_INTR_ENABLE = 0x10002018,
