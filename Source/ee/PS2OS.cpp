...
{
	m_ee.m_pMemoryMap->SetWord(CDMAC::D5_CHCR, 0);
	m_ee.m_pMemoryMap->SetWord(CDMAC::D5_QWC, 0);
}

//6F
void CPS2OS::sc_GetOsdConfigParam2()
{
}
...
CPS2OS::SystemCallHandler CPS2OS::m_sysCall[0x80] =
{
	...
	//0x68
	&CPS2OS::sc_FlushCache,			&CPS2OS::sc_Unhandled,				&CPS2OS::sc_Unhandled,				&CPS2OS::sc_SifStopDma,				&CPS2OS::sc_Unhandled,			&CPS2OS::sc_Unhandled,				&CPS2OS::sc_Unhandled,			&CPS2OS::sc_GetOsdConfigParam2,
	//0x70
